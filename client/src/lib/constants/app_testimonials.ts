...
export class AppTestimonials {
  ...
  static readonly testimonials: Testimonial[] = [
    new Testimonial({
      ...
      testimonial:
        "Abhishek is a brilliant developer who can make everything happen for your project. We've worked together on front-end Flutter, covering iOS, Android, iPad, and Web, where the features were supported by a well-working design system that covered all platforms. He is technically super savvy, always polite, and never falls short on his promises. He works great in a team and will effortlessly translate your business requirements to technical requirements.",
      linkedin: "https://www.linkedin.com/in/sorenrt/",
    }),
    new Testimonial({
      name: "Jahid Hasan",
      ...
      linkedin: "https://www.linkedin.com/in/jhasan94",
    }),
    new Testimonial({
      name: "Krish Krithivasan",
      position: "Co-Founder @QStudio",
      testimonial:
      ...
      linkedin: "https://www.linkedin.com/in/krishkrithivasan/",
    }),
    new Testimonial({
      name: "Chip Whitmer",
      position: "VP of Software Development @Ostrich Cyber-Risk",
      testimonial:
      ...
      linkedin: "https://www.linkedin.com/in/chip-whitmer-60832a6/",
    }),
    new Testimonial({
      name: "Khusboo Rathod",
      ...
      linkedin: "https://www.linkedin.com/in/khushboojrathod",
    }),
    new Testimonial({
      name: "Purvik Rana",
      ...
      linkedin: "https://www.linkedin.com/in/purvikrana",
    }),
    new Testimonial({
      ...
      linkedin: "https://www.linkedin.com/in/chirag-kalsariya-28594179/",
    }),
    new Testimonial({
      name: "Jayesh Seth",
      position: "SDE @Moneyview",
      testimonial:
    ...
    new Testimonial({
      ...
      linkedin: "https://www.linkedin.com/in/abhineya-beduru",
    }),
    new Testimonial({
      name: "Matthias Raaz",
      position: "Founder @Deep5",
      testimonial:
      ...
      linkedin: "https://www.linkedin.com/in/matthias-raaz",
    }),
    new Testimonial({
      name: "Utsav Ghimire",
      position: "Sr. Software Engineer",
      testimonial:
        "Working with Abhishek was not only professionally rewarding but also a genuinely pleasant experience. His positive attitude, collaborative nature, and strong work ethic made our collaboration enjoyable.\n\nI am genuinely looking forward to the opportunity to work with Abhishek on future projects. He's a valuable asset to any team, and I highly recommend him for his outstanding skills and his ability to foster a positive and productive work environment :)",
      linkedin: "https://www.linkedin.com/in/theutsavg/",
    }),
    new Testimonial({
      name: "Gyan Upadhyay",
    ...
    new Testimonial({
      ...
      position: "Co-Founder @Verionyx Solutions",
      testimonial:
